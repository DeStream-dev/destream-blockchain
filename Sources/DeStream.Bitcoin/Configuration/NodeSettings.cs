...
namespace DeStream.Bitcoin.Configuration
{
    ...
    public class NodeSettings
    {
        ...
        public NodeSettings(Network innerNetwork = null, ProtocolVersion protocolVersion = SupportedProtocolVersion, 
            string agent = "DeStreamBitcoin", string[] args = null, bool loadConfiguration = true)
        {
            this.Agent = agent;
        ...
        public static void PrintHelp(Network network)
        {
            ...
            builder.AppendLine(" dotnet exec <DeStream.DeStreamD/BitcoinD.dll> [arguments]");
            builder.AppendLine();
