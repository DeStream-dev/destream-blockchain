...
namespace DeStream.Bitcoin.Features.Api
{
    ...
    public class ApiSettings
    {
        ...
        public const int DefaultDeStreamApiPort = 37221;
        ...
        /// <summary>The default port used by the API when the node runs on the DeStream testnet network.</summary>
        public const int TestDeStreamApiPort = 38221;
