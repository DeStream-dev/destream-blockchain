...
namespace DeStream.Bitcoin.Features.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "DeStream.Bitcoin.Api", Version = "v1" });

                //Set the comments path for the swagger json and ui.
                var basePath = PlatformServices.Default.Application.ApplicationBasePath;
                var apiXmlPath = Path.Combine(basePath, "DeStream.Bitcoin.Api.xml");
                var walletXmlPath = Path.Combine(basePath, "DeStream.Bitcoin.LightWallet.xml");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DeStream.Bitcoin.Api V1");
            });
        }
    }
}
