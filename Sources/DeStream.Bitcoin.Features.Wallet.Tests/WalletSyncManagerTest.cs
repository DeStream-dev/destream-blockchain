...
namespace DeStream.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        {
            // These tests use Network.DeStreamMain.
            ...
            this.chain = new ConcurrentChain(Network.DeStreamMain);
        ...
        public void Start_HavingPrunedStoreSetting_ThrowsWalletException()
        {
            ...
            var walletSyncManager = new WalletSyncManager(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.DeStreamMain,
        ...
        {
            this.storeSettings.Prune = false;
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(5, Network.DeStreamMain);
        ...
        {
            var result = WalletTestsHelpers.GenerateChainAndBlocksWithHeight(5, Network.DeStreamMain);
            this.chain = result.Chain;
            var blocks = result.Blocks;
            var walletSyncManager = new WalletSyncManagerOverride(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.DeStreamMain,
                this.blockStoreCache.Object, this.storeSettings, this.nodeLifetime.Object);
        ...
        {
            var result = WalletTestsHelpers.GenerateForkedChainAndBlocksWithHeight(5, Network.DeStreamMain, 2);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(3, Network.DeStreamMain);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(1, Network.DeStreamMain);
