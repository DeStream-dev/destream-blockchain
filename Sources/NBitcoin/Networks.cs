    ...
    public partial class Network
    {
        ...
        private static Network InitDeStreamTest()
        {
            ...
            network.SeedNodes.AddRange(new[]
            {
                ...
                new NetworkAddress(IPAddress.Parse("95.128.181.103"), network.DefaultPort),    //peak-srv-16
                new NetworkAddress(IPAddress.Parse("95.128.181.80"), network.DefaultPort)      //peak-srv-17
            });
