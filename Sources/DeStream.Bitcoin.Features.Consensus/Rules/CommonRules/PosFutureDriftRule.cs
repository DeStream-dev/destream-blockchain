...
namespace DeStream.Bitcoin.Features.Consensus.Rules.CommonRules
{
    /// <summary>
    ...
    public class PosFutureDriftRule : PosConsensusRule
    {
        ...
        private bool IsDriftReduced(long time)
        {
            ...
            // this is a specific DeStream bug fix where the blockchain drifted 24 hour ahead as the protocol allowed that.
