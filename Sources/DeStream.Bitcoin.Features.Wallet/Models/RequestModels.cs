...
using DeStream.Bitcoin.Features.Wallet.Validations;
using DeStream.Bitcoin.Utilities.ValidationAttributes;
...
namespace DeStream.Bitcoin.Features.Wallet.Models
{
    ...
    /// </summary>
    /// <seealso cref="DeStream.Bitcoin.Features.Wallet.Models.RequestModel" />
