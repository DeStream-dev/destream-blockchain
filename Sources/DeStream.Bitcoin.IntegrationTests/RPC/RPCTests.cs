...
{
    /// <summary>
    /// DeStream test fixture for RPC tests.
    /// </summary>
    public class RpcTestFixtureDeStream : RpcTestFixtureBase
    {
        /// <inheritdoc />
        protected override void InitializeFixture()
        {
            this.Builder = NodeBuilder.Create();
            this.Node = this.Builder.CreateDeStreamPowNode();
    ...
    public class RpcTests : IClassFixture<RpcTestFixtureDeStream>
    {
        private readonly RpcTestFixtureDeStream rpcTestFixture;

        public RpcTests(RpcTestFixtureDeStream RpcTestFixture)
        {
