...
namespace DeStream.Bitcoin.IntegrationTests.RPC
{
    ...
    public class GetStakingInfoActionTests
    {
        ...
        public void GetStakingInfo_StakingEnabled()
        {
            ...
            {
                IFullNode fullNode = DeStreamBitcoinPosRunner.BuildStakingNode(dir.FolderName);
        ...
        public void GetStakingInfo_StartStaking()
        {
            using (var dir = TestDirectory.Create())
            {
                IFullNode fullNode = DeStreamBitcoinPosRunner.BuildStakingNode(dir.FolderName, false);
