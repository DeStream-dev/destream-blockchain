...
namespace DeStream.Bitcoin.IntegrationTests.EnvironmentMockUpHelpers
{
    ...
    public class DeStreamBitcoinPosRunner : INodeRunner
    {
        private Action<IFullNodeBuilder> callback;

        public DeStreamBitcoinPosRunner(Action<IFullNodeBuilder> callback = null)
        {
    ...
    public class DeStreamBitcoinPowRunner : INodeRunner
    {
        private Action<IFullNodeBuilder> callback;

        public DeStreamBitcoinPowRunner(Action<IFullNodeBuilder> callback = null) : base()
        {
            this.callback = callback;
        }
