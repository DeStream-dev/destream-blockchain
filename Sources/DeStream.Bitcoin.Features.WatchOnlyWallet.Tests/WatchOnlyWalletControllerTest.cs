...
using Moq;
using DeStream.Bitcoin.Features.WatchOnlyWallet.Controllers;
using DeStream.Bitcoin.Features.WatchOnlyWallet.Models;
using DeStream.Bitcoin.Utilities.JsonErrors;
using Xunit;

namespace DeStream.Bitcoin.Features.WatchOnlyWallet.Tests
{
